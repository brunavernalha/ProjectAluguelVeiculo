...
public class AppModule
{
	 ...
	 * InternalConstants.TAPESTRY_APP_PACKAGE_PARAM + ".entities" (witch is equal to "org.example.entities")
	 * for annotated entity classes.
	 *
	 * Contributes the package "org.example.model" to the configuration, so that it will be
...
//		configuration.add("org.example.model");
	}
